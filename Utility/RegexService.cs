...
namespace MinecraftLanguageModelLibrary.Utility
{
    public partial class RegexService
    {
        [GeneratedRegex(@"minecraft:\w")]
        public partial Regex GetDispatchFeaturePath();
        [GeneratedRegex(@"[-+]?\d+")]
        public partial Regex GetIntegerData();
